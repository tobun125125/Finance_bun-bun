...
export function ActionButtons() {
  return (
    <section className="grid grid-cols-2 gap-4 mt-6">
      <button className="flex flex-col items-center justify-center gap-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 transition-all hover:bg-zinc-50 dark:hover:bg-zinc-800 shadow-sm active:scale-95">
